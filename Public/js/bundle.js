...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiY2FsdW1iMTMiLCJhIjoiY2tqOHhzOXd2MXRtNDJ5bnE4cjhsdmthYiJ9.dyBph-YzFlXuuG0rHgUpfw";
  var map = new mapboxgl.Map({
    container: "map",
    //section element with id=map uses this container
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            console.log(_context.t0.result.data.message); //Message property of response
...
if (mapBox) {
  ...
  var locations = JSON.parse(document.getElementById("map").dataset.locations); //Grab the section element with id=map from tour.pug
